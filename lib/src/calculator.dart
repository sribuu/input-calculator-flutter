...
class _CalculatorState extends State<Calculator> {
  ...
  Widget build(BuildContext context) {
    final inputContainerHeight = MediaQuery.of(context).size.height / 4;
    final keyboardTopOverlad =
        (inputContainerHeight - (MediaQuery.of(context).size.height / 4));
  ...
  Widget _buildButtom(
    ...
    return Expanded(
      flex: title == CalculatorOperator.equal ||
              title == CalculatorOperator.submit
          ? 2
          : 1,
      child: Container(
        padding: padding,
  ...
  _KeyboardButton({
    ...
    CalculatorThemes theme,
          ...
          child: Padding(
            ...
            child: title == CalculatorOperator.submit
                ...
                : Text(
                    ...
                    style: TextStyle(
                      ...
                      color:
                          onPressed != null ? titleColor : Colors.grey.shade300,
                    ),
                  ),
          ),
          onPressed: onPressed,
